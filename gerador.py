...
####################
#
# As imagens e o arquivo de texto devem estar na mesma pasta do código
# o arquivo de texto deve estar no formato .txt 
# o arquivo de texto com as menssagens devem segui o exemplo a baixo
# Titulo,Texto do meio,Texto de baixo.
#
